...
namespace Common.Logging.MultiFactory
{
	...
	/// </summary>
	public class MultiFactoryLoggerFactoryAdapter : ILoggerFactoryAdapter
	{
		/// <summary>
		...
		/// </summary>
		public MultiFactoryLoggerFactoryAdapter()
		{
		...
		public MultiFactoryLoggerFactoryAdapter(List<ILoggerFactoryAdapter> factoryAdapters)
		{
