...
namespace Common.Logging.MultiFactory
{
	/// <summary>
	...
	public class MultiLogger : ILog
	{
		...
		{
			Loggers.ForEach(l => l.Debug(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Debug(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Debug(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Debug(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Debug(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.DebugFormat(formatProvider, format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.DebugFormat(formatProvider, format, args));
		}
		...
		{
			Loggers.ForEach(l => l.Error(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Error(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Error(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Error(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Error(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.DebugFormat(format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Fatal(message));
		}
		...
		{
			Loggers.ForEach(l => l.FatalFormat(formatProvider, format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.FatalFormat(formatProvider, format, args));
		}
		...
		{
			Loggers.ForEach(l => l.FatalFormat(format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.FatalFormat(format, args));
		}
		...
		{
			Loggers.ForEach(l => l.Info(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Info(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Info(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Info(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Info(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.InfoFormat(formatProvider, format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.InfoFormat(formatProvider, format, args));
		}
		...
		{
			Loggers.ForEach(l => l.InfoFormat(format, exception, args));
		}
		...
		{
			get { return Loggers.Any(x => x.IsDebugEnabled); }
		}
		...
		{
			get { return Loggers.Any(x => x.IsErrorEnabled); }
		}
		...
		{
			get { return Loggers.Any(x => x.IsFatalEnabled); }
		}
		...
		{
			get { return Loggers.Any(x => x.IsInfoEnabled); }
		}
		...
		{
			get { return Loggers.Any(x => x.IsTraceEnabled); }
		}
		...
		{
			get { return Loggers.Any(x => x.IsWarnEnabled); }
		}
		...
		{
			Loggers.ForEach(l => l.Trace(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Trace(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Trace(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Trace(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Trace(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Trace(message));
		}
		...
		{
			Loggers.ForEach(l => l.TraceFormat(formatProvider, format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.TraceFormat(formatProvider, format, args));
		}
		...
		{
			Loggers.ForEach(l => l.TraceFormat(format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.TraceFormat(format, args));
		}
		...
		{
			Loggers.ForEach(l => l.Warn(formatProvider, formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Warn(formatProvider, formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Warn(formatMessageCallback, exception));
		}
		...
		{
			Loggers.ForEach(l => l.Warn(formatMessageCallback));
		}
		...
		{
			Loggers.ForEach(l => l.Warn(message, exception));
		}
		...
		{
			Loggers.ForEach(l => l.WarnFormat(formatProvider, format, exception, args));
		}
		...
		{
			Loggers.ForEach(l => l.WarnFormat(formatProvider, format, args));
		}
		...
		{
			Loggers.ForEach(l => l.WarnFormat(format, exception, args));
		}
